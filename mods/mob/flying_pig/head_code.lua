...
--[[
flying_pig.raycast_look = function(self,dtime)
...
flying_pig.look_below = function(self)
	if self.yaw then
...
flying_pig.move_head = function(self,pos2,dtime)
	if self.child then
...
flying_pig.return_head_to_origin = function(self,dtime)
	local current_yaw = self.head_rotation.y
	local current_pitch = self.head_rotation.z
