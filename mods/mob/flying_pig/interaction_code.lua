...
flying_pig.add_sword_wear = function(self, puncher, time_from_last_punch, tool_capabilities, dir)
...
flying_pig.do_critical_particles = function(pos)
...
flying_pig.on_punch = function(self, puncher, time_from_last_punch, tool_capabilities, dir)
	local hp = self.hp
...
flying_pig.on_death = function(self, killer)
...
flying_pig.manage_death_animation = function(self,dtime)
...
flying_pig.look_around = function(self,dtime)
	local pos = self.object:get_pos()
