...
--[[
slime.raycast_look = function(self,dtime)
...
slime.look_below = function(self)
	if self.yaw then
...
slime.move_head = function(self,pos2,dtime)
	if self.child then
...
slime.return_head_to_origin = function(self,dtime)
	local current_yaw = self.head_rotation.y
	local current_pitch = self.head_rotation.z
