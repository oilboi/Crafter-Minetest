...
exploder.add_sword_wear = function(self, puncher, time_from_last_punch, tool_capabilities, dir)
...
exploder.do_critical_particles = function(pos)
...
exploder.on_punch = function(self, puncher, time_from_last_punch, tool_capabilities, dir)
	local hp = self.hp
...
exploder.on_death = function(self, killer)
...
exploder.manage_death_animation = function(self,dtime)
...
exploder.look_around = function(self,dtime)
	local pos = self.object:get_pos()
