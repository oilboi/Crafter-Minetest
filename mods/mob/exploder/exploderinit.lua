...
exploder.initial_properties = {
	...
	mesh = "exploder.b3d",
	textures = {
		"grass.png","grass.png","grass.png","grass.png","grass.png","exploder_head.png"
...
exploder.mob = true
exploder.hostile = false
exploder.hostile_timer = 0
exploder.timer = 0

exploder.state = 0
exploder.hunger = 200
exploder.view_distance = 20

exploder.punch_timer = 0
exploder.punched_timer = 0


--head stuff
exploder.head_mount = vector.new(0,1.2,1.9)
local path = minetest.get_modpath(minetest.get_current_modname()).."/exploder"
...
exploder.set_animation = function(self)
...
exploder.do_hunger = function(self,dtime)
	self.hunger = self.hunger - dtime
end

--this sets the state of the mob
exploder.set_state = function(self,dtime)
...
minetest.register_entity("mob:exploder", exploder)
...
--[[
exploder.head = {}
exploder.head.initial_properties = {
	hp_max = 1,
	physical = false,
	collide_with_objects = false,
...
exploder.head.on_step = function(self, dtime)
	if self.parent == nil then
		self.object:remove()
	end
end
minetest.register_entity("mob:exploder_head", exploder.head)
