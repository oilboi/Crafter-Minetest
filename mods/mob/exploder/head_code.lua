...
--[[
exploder.raycast_look = function(self,dtime)
...
exploder.look_below = function(self)
	if self.yaw then
...
exploder.move_head = function(self,pos2,dtime)
	if self.child then
...
exploder.return_head_to_origin = function(self,dtime)
	local current_yaw = self.head_rotation.y
	local current_pitch = self.head_rotation.z
